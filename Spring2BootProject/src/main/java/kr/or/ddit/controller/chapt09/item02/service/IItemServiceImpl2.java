...
@Service
public class IItemServiceImpl2 implements IItemService2{
	...
	public void modify(Item2 item) {
		...
		// 3. 새롭게 추가된 파일들을 다시 add 추가 (add있지만 새롭게!)
		for(String fileName : files) {
	...
	public void remove(int itemId) {
		mapper.deleteAttach(itemId); // 자식 테이블 먼저 지우고
		mapper.delete(itemId);		// 그다음 부모테이블 지우고
	}
