						...
						<div class="col-lg-12 grid-margin stretch-card">
							<div class="card">
								<div class="card-body">
									...
									<form class="forms-sample" id="bForm" action="/crud1/board/insert.do" method="post">
								...
								<div class="card-body">
									...
									<c:choose>
										<c:when test="${status eq 'u'}">
											<button type="button" class="btn btn-inverse-danger mr-2" onclick="location.href='/crud1/board/${board.boNo }'">${cancelText }</button>
										</c:when>
										<c:otherwise>
...
$(function(){
	...
	addBtn.on("click", function(){
		...
		if($(this).text() == "수정") {
			bForm.attr("action", "/crud1/board/update.do");
		}
		bForm.submit();
	});
