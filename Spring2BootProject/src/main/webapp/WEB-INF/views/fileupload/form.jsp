						...
						<div class="col-lg-12 grid-margin stretch-card">
							<div class="card">
								...
								<div class="card-body">
									...
									<form action="/fileupload/register" method="post">
									...
									<form action="/fileupload/register2" method="post" enctype="multipart/form-data">
										상품명 : <input type="text" name="prodName" /><br/>
