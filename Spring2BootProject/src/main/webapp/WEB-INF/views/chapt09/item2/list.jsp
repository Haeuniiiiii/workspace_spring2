					...
					<div class="row">
						<div class="col-lg-12 grid-margin stretch-card">
							<div class="card">
								...
								<div class="card-body">
									<p class="card-description">FILEUPLOAD2 REGISTER</p>
									
									<div style="margin-bottom: 10px;">
										<input type="button" class="btn btn-primary" onclick="javascript:location.href='/item2/register'" value="등록">
									</div>
									
									<table class="table table-bordered">
										<tr>
											<th align="center" width="15%">상품ID</th>
											<th align="center" width="40%">상품명</th>
											<th align="center" width="15%">가격</th>
											<th align="center" width="15%">편집</th>
											<th align="center" width="15%">제거</th>
										</tr>
										<c:choose>
