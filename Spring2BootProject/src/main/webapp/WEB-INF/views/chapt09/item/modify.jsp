					...
					<div class="row">
						<div class="col-lg-12 grid-margin stretch-card">
							<div class="card">
								...
								<div class="card-body">
									<p class="card-description">FILEUPLOAD MODIFY</p>
									...
									<form action="/item/modify" method="post" enctype="multipart/form-data">
										...
										<table class="table table-bordered">
											...
											<tr>
												...
												<td>
													...
													style="border-radius: 0% !important; width: 250px; height: 200px;">
												</td>										
											</tr>
											<tr>
												<td>파일</td>
										...
										<button class="btn btn-success" type="button" onclick="javascript:location.href='/item/list'">LIST</button>
									</form>
								</div>
							</div>
						</div>
