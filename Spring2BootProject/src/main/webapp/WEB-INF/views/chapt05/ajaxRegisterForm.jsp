...
$(function() {
   ...
   let registerBtn03 = $("#registerBtn03");   // 세 번째 등록 버튼
   let registerBtn04 = $("#registerBtn04");   // 네 번째 등록 버튼
   let registerBtn05 = $("#registerBtn05");   // 다섯 번째 등록 버튼
   let registerBtn06 = $("#registerBtn06");   // 여섯 번째 등록 버튼
   ...
   registerBtn03.on("click", function() {
      ...
      // Ajax 요청 시작
      $.ajax({
         url: "/chapt05/ajax/register03?userId=" + userId,                 // 다른 URL로 요청
         type: "post",
         data: JSON.stringify(userObject),
         contentType: "application/json; charset=utf-8",
   ...
   registerBtn04.on("click", function() {
      ...
      // Ajax 요청 시작
      $.ajax({
         url: "/chapt05/ajax/register04" ,                 // 다른 URL로 요청
         type: "post",
   ...
   registerBtn05.on("click", function() {
      ...
      // Ajax 요청 시작
      $.ajax({
         url: "/chapt05/ajax/register05" ,                 // 다른 URL로 요청
         type: "post",
         data: JSON.stringify(userObject),
         contentType: "application/json; charset=utf-8",
   ...
   registerBtn06.on("click", function() {
      ...
      // Ajax 요청 시작
      $.ajax({
         url: "/chapt05/ajax/register06" ,                 // 다른 URL로 요청
         type: "post",
         data: JSON.stringify(userObject),
         contentType: "application/json; charset=utf-8",
