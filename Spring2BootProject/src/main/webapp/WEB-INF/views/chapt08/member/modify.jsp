					...
					<div class="row">
						<div class="col-lg-12 grid-margin stretch-card">
							<div class="card">
								...
								<div class="card-body">
									<p class="card-description">MEMBER MODIFY</p>
									<form action="/crud/member/modify" method="post" id="member">
										...
										<table class="table table-bordered">
											...
											<tr>
												<td>userName</td>
												<td>
													<input class="form-control" type="text" name="userName" id="userName" value="${member.userName }" />
												</td>
											</tr>
											<tr>
												<td>auth (1)</td>
												<td>
													<select name="authList[0].auth" class="form-select" >
											...
											<tr>
												<td>auth (2)</td>
												<td>
													<select name="authList[1].auth" class="form-select" >
														<option value="">--- 선택해주세요 ---</option>
														<option value="">--- 선택해주세요 ---</option>
											...
											<tr>
												<td>auth (3)</td>
												<td>
													<select name="authList[2].auth" class="form-select" >
														<option value="">--- 선택해주세요 ---</option>
									...
									<div class="d-grid gap-2 d-md-flex justify-content-md-end">
										...
										<input type="button" id="btnCancel" value="취소" class="btn btn-danger"/>
									</div>
								</div>
							</div>
						</div>
