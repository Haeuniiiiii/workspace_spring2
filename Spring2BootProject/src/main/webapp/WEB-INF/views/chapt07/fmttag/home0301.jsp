							...
							<div class="card">
								...
								<div class="card-body">
									...
									<!-- 
										...
										a 	:	오전오후
									 -->
									<p><strong># (*가장많이사용) pattern 속성을 지정하여 날짜를 포맷팅한다.</strong></p>
									<p>now : ${now }</p>
									...
									<p><strong># type 속성을 date로 지정해 날짜를 포맷팅한다.</strong></p>
									<p>now : ${now }</p>
									...
									<p><strong># 각 type 속성을 time로 지정해 날짜를 포맷팅한다. </strong></p>
									<p>now : ${now }</p>
									...
									<p><strong># 각 type 속성을 both로 지정하여 날짜, 시간 둘 다 포맷팅한다. </strong></p>
									<p>now : ${now }</p>
