...
<body>
	...
	<main>
		...
		<section class="py-1 text-center container">
			<form class="album py-1 bg-light" action="/register" method="post" id="dditboard">
				<div class="">
					<div class="container">
						<div class="card-body">
							...
							<div class="input-group input-group-lg">
								...
								<textarea id="boContent" name="boContent" class="form-control" aria-label="With textarea" rows="12" ></textarea>
							</div>
							<div class="input-group input-group-lg">
						...
						<div class="card-footer" align="right">
							...
							<input type="button" class="btn btn-info" id="listBtn" value="목록"/>
						</div>
					</div>
				</div>
			</form>
